                ...
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <div className="bottom-prag">
                            <p><i className="fas fa-quote-right" ></i><span>%40 من أمرض السرطان يمكن الوقاية منها باتباع نمط حياة وعادات </span><span>غذائية صحية وممارسة النشاط البدني، في حين أن %40 أخرى يمكن شفاؤها </span><span>بأذن الله تعالى إذا ما تم تشخيصها مبكراً وخضعت للعلاج المناسب <i className="fas fa-quote-left" ></i></span> </p>
